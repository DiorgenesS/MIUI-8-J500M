...
.field private static final CONTACT_SHARING_MASK:J = 0x400000000000000L
...
.field private static final DEFAULT_RESTRICTION_MASK:J = 0x7fffffc3b9fffefL
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "com.sec.sprextension.phoneinfo"
...
.method static synthetic access$1100(Lcom/android/server/enterprise/restriction/RestrictionPolicy;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
...
.method static synthetic access$800(Lcom/android/server/enterprise/restriction/RestrictionPolicy;IZ)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/enterprise/restriction/RestrictionPolicy;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
...
.method private enforceAdvancedRestrictionPermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    ...
    const-string/jumbo v1, "com.sec.enterprise.knox.permission.KNOX_RESTRICTION"
...
.method private initializeCacheAsUser(I)V
    ...
    const-wide v2, 0x7fffffc3b9fffefL
...
.method private loadRestrictionCache(I)V
    ...
    .prologue
    .line 2837
    const-wide v24, 0x7fffffc3b9fffefL
...
.method private sendSeletiveFotaResult(I)V
    ...
    const-string/jumbo v1, "com.sec.enterprise.intent.extra.UPDATE_FOTA_VERSION_RESULT"
...
.method public isContactsSharingEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
    .locals 2
    .param p1, "cxtInfo"    # Landroid/app/enterprise/ContextInfo;
    .param p2, "showMsg"    # Z
    ...
    .line 2009
    .local v0, "userId":I
    invoke-virtual {p0, p2, v0}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isContactsSharingEnabledAsUser(ZI)Z
...
.method public isContactsSharingEnabledAsUser(ZI)Z
    .locals 4
    .param p1, "showMsg"    # Z
    .param p2, "userId"    # I
    ...
    const-string/jumbo v3, "isContactsSharingEnabled : "
...
.method public onAdminRemoved(I)V
    ...
    invoke-virtual {p0, v0, v5, v5}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->setAllowedFOTAVersion(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Landroid/os/Bundle;)Z
...
.method public setAllowedFOTAVersion(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    .line 5416
    .local v2, "defaultCorp":Ljava/lang/String;
    iget v9, p1, Landroid/app/enterprise/ContextInfo;->mCallerUid:I

    invoke-direct {p0, v9, v0, p2}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->isUpdatableSelectiveFota(ILjava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v9}, Lcom/android/server/enterprise/restriction/RestrictionPolicy;->sendSeletiveFotaResult(I)V
    ...
    .line 5428
    const-string/jumbo v9, "com.sec.enterprise.bundle.CORPID"
    ...
    const-string/jumbo v10, "setAllowedFOTAVersion : sendBroadcast : sec.fota.intent.MDM_REGISTER"
    ...
    const-string/jumbo v9, "sec.fota.intent.MDM_REGISTER"
    ...
    invoke-virtual {p2, v9, v10}, Ljava/lang/String;->indexOf(Ljava/lang/String;I)I
    ...
    const-string/jumbo v11, "setAllowedFOTAVersion : invalid format : "
    ...
    invoke-virtual {v1, v9, p2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v10, "SelectiveFotaTable"

    invoke-virtual {v9, v10, v1, v7}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->put(Ljava/lang/String;Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    ...
    const-string/jumbo v11, "setAllowedFOTAVersion : corpID = "
...
.method public setContactsSharingEnabled(Landroid/app/enterprise/ContextInfo;Z)Z
    .locals 7
    .param p1, "cxtInfo"    # Landroid/app/enterprise/ContextInfo;
    .param p2, "enable"    # Z
    ...
    const-string/jumbo v2, "setContactsSharingEnabled : "
    ...
    const-string/jumbo v3, "contactSharingEnabled"
    ...
    .line 1993
    .local v6, "ret":Z
    const-string/jumbo v1, "contactSharingEnabled"
