...
.method private retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;IIIZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    .line 1151
    .local v24, "comp":Landroid/content/ComponentName;
    if-eqz v24, :cond_0
    ...
    .line 1162
    .local v28, "ekm":Lcom/sec/enterprise/knox/EnterpriseKnoxManager;
    :try_start_0
    move-object/from16 v0, p0
    ...
    .line 1163
    .local v26, "containerMgr":Lcom/sec/enterprise/knox/container/KnoxContainerManager;
    if-eqz v26, :cond_1
    ...
    .line 1165
    .local v23, "ccp":Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;
    invoke-virtual/range {v23 .. v23}, Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;->isBluetoothEnabled()Z
    :try_end_0
    ...
    .line 1171
    .end local v23    # "ccp":Lcom/sec/enterprise/knox/container/ContainerConfigurationPolicy;
    .end local v26    # "containerMgr":Lcom/sec/enterprise/knox/container/KnoxContainerManager;
    .end local v28    # "ekm":Lcom/sec/enterprise/knox/EnterpriseKnoxManager;
    :cond_1
    :goto_0
    if-nez v20, :cond_2
    ...
    .end local v22    # "callingUser":I
    .end local v24    # "comp":Landroid/content/ComponentName;
    ...
    .line 1184
    .local v34, "smap":Lcom/android/server/am/ActiveServices$ServiceMap;
    invoke-virtual/range {p1 .. p1}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;

    move-result-object v24

    .line 1185
    .restart local v24    # "comp":Landroid/content/ComponentName;
    if-eqz v24, :cond_13
    ...
    .line 1198
    .local v21, "callee":Ljava/lang/String;
    if-eqz v24, :cond_7
    ...
    .line 1211
    .end local v21    # "callee":Ljava/lang/String;
    :cond_5
    invoke-static {}, Landroid/app/AppGlobals;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    .line 1167
    .end local v3    # "r":Lcom/android/server/am/ServiceRecord;
    .end local v34    # "smap":Lcom/android/server/am/ActiveServices$ServiceMap;
    .restart local v20    # "bypassHandleIncomingUser":Z
    .restart local v22    # "callingUser":I
    .restart local v25    # "component":Ljava/lang/String;
    .restart local v28    # "ekm":Lcom/sec/enterprise/knox/EnterpriseKnoxManager;
    ...
    .end local v31    # "r":Lcom/android/server/am/ServiceRecord;
    .restart local v3    # "r":Lcom/android/server/am/ServiceRecord;
    .restart local v21    # "callee":Ljava/lang/String;
    .restart local v24    # "comp":Landroid/content/ComponentName;
    .restart local v34    # "smap":Lcom/android/server/am/ActiveServices$ServiceMap;
    :cond_7
    :try_start_2
    ...
    .line 1231
    :cond_a
    new-instance v33, Landroid/content/pm/ServiceInfo;
    ...
    .line 1232
    .end local v8    # "sInfo":Landroid/content/pm/ServiceInfo;
    .local v33, "sInfo":Landroid/content/pm/ServiceInfo;
    move-object/from16 v0, p0
    ...
    .line 1234
    .end local v33    # "sInfo":Landroid/content/pm/ServiceInfo;
    :cond_b
    move-object/from16 v0, v34
    ...
    check-cast v31, Lcom/android/server/am/ServiceRecord;
    :try_end_2
    ...
    .line 1241
    .local v35, "stats":Lcom/android/internal/os/BatteryStatsImpl;
    monitor-enter v35
    :try_end_3
    .catch Landroid/os/RemoteException; {:try_start_3 .. :try_end_3} :catch_1
    ...
    .line 1254
    .local v30, "pr":Lcom/android/server/am/ServiceRecord;
    ...
    .end local v3    # "r":Lcom/android/server/am/ServiceRecord;
    .end local v29    # "i":I
    .end local v30    # "pr":Lcom/android/server/am/ServiceRecord;
    .restart local v31    # "r":Lcom/android/server/am/ServiceRecord;
    :catchall_0
    move-exception v4
    ...
    .end local v35    # "stats":Lcom/android/internal/os/BatteryStatsImpl;
    :catch_1
    move-exception v4
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    .line 2639
    .local v8, "canceled":Z
    sget-boolean v19, Lcom/android/server/am/DynamicHiddenApp;->MDHA_SSR_ENABLE:Z
    ...
    invoke-virtual/range {v19 .. v20}, Lcom/android/server/am/DynamicHiddenApp;->isWidgetUsingPkg(Ljava/lang/String;)Z
