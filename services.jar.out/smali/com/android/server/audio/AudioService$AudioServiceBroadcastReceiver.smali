...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    # getter for: Lcom/android/server/audio/AudioService;->mExtendedDisplayListener:Landroid/hardware/display/ExtendedDisplayListener;
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->access$12000(Lcom/android/server/audio/AudioService;)Landroid/hardware/display/ExtendedDisplayListener;
    ...
    invoke-virtual {v0, v2, v5}, Landroid/hardware/display/DisplayManager;->registerDisplayListener(Landroid/hardware/display/ExtendedDisplayListener;Landroid/os/Handler;)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->access$12100(Lcom/android/server/audio/AudioService;)I
    ...
    invoke-virtual {v0, v2}, Landroid/hardware/display/DisplayManager;->unregisterDisplayListener(Landroid/hardware/display/ExtendedDisplayListener;)V
    ...
    invoke-static {v5, v2}, Lcom/android/server/audio/AudioService;->access$12202(Lcom/android/server/audio/AudioService;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->access$12300(Lcom/android/server/audio/AudioService;)Lcom/sec/android/emergencymode/EmergencyManager;
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->access$12400(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static {v2, v5}, Lcom/android/server/audio/AudioService;->access$12402(Lcom/android/server/audio/AudioService;Ljava/lang/String;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/audio/AudioService;->mExternalUsbInfo:Ljava/lang/String;
    invoke-static {v6}, Lcom/android/server/audio/AudioService;->access$12400(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/audio/AudioService;->mExternalUsbInfo:Ljava/lang/String;
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->access$12400(Lcom/android/server/audio/AudioService;)Ljava/lang/String;
    ...
    invoke-static/range {v2 .. v7}, Lcom/android/server/audio/AudioService;->access$12500(Lcom/android/server/audio/AudioService;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lcom/android/server/audio/AudioService;->access$12800(Lcom/android/server/audio/AudioService;)I
    ...
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->access$13200(Lcom/android/server/audio/AudioService;)I

    move-result v5

    # invokes: Lcom/android/server/audio/AudioService;->setNaturalSoundMode(I)V
    invoke-static {v2, v5}, Lcom/android/server/audio/AudioService;->access$13300(Lcom/android/server/audio/AudioService;I)V
    ...
    invoke-static {v2}, Lcom/android/server/audio/AudioService;->access$13400(Lcom/android/server/audio/AudioService;)V
    ...
    invoke-static {v2, v5}, Lcom/android/server/audio/AudioService;->access$13602(Lcom/android/server/audio/AudioService;Z)Z
    ...
    invoke-static {v5}, Lcom/android/server/audio/AudioService;->access$13600(Lcom/android/server/audio/AudioService;)Z
    ...
    .end local v36    # "userIdForCurrentAudioFocus":I
    .restart local v29    # "outDevice":I
    .restart local v34    # "state":I
    :cond_42
