...
.method computeShownFrameLocked()V
    ...
    .line 1324
    .local v34, "wallpaperTarget":Lcom/android/server/wm/WindowState;
    :goto_2
    const/16 v18, 0x0
    ...
    .line 1329
    .local v33, "wallpaperAnimator":Lcom/android/server/wm/WindowStateAnimator;
    ...
    invoke-virtual/range {v38 .. v38}, Landroid/view/animation/Animation;->getDetachWallpaper()Z
    ...
    const-string v40, "WP target attached xform: "
    ...
    .line 1339
    .local v35, "wpAppAnimator":Lcom/android/server/wm/AppWindowAnimator;
    :goto_3
    if-eqz v35, :cond_1
    ...
    const-string v40, "WP target app xform: "
    ...
    .line 1376
    .end local v33    # "wallpaperAnimator":Lcom/android/server/wm/WindowStateAnimator;
    .end local v35    # "wpAppAnimator":Lcom/android/server/wm/AppWindowAnimator;
    :cond_1
    move-object/from16 v0, p0
    ...
    .line 1404
    .local v31, "virtualScreenOffset":Landroid/graphics/PointF;
    const/16 v38, 0x0
    ...
    .line 1415
    .local v30, "tmpMatrix":Landroid/graphics/Matrix;
    if-eqz v25, :cond_20
    ...
    invoke-virtual/range {v38 .. v38}, Lcom/android/server/wm/WindowState;->getMultiWindowStyleLw()Lcom/samsung/android/multiwindow/MultiWindowStyle;
    ...
    div-float v40, v32, v40

    const/high16 v41, 0x40000000    # 2.0f

    div-float v41, v14, v41
    ...
    invoke-virtual/range {v38 .. v38}, Landroid/view/animation/Transformation;->getMatrix()Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v38 .. v39}, Landroid/graphics/RectF;->set(Landroid/graphics/RectF;)V
    ...
    invoke-static/range {v38 .. v38}, Landroid/graphics/PixelFormat;->formatHasAlpha(I)Z
    ...
    invoke-virtual/range {v38 .. v42}, Lcom/android/server/wm/WindowState;->isIdentityMatrix(FFFF)Z
    ...
    invoke-virtual/range {v38 .. v39}, Landroid/graphics/Rect;->scale(F)V
    ...
    invoke-virtual/range {v38 .. v38}, Lcom/android/server/wm/WindowState;->getMainWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual/range {v38 .. v40}, Landroid/graphics/Rect;->offset(II)V
    ...
    .line 1670
    :cond_17
    sget-boolean v38, Lcom/android/server/wm/WindowManagerService;->DEBUG_SURFACE_TRACE:Z
    ...
    .end local v14    # "h":I
    .end local v29    # "tmpFloats":[F
    .end local v30    # "tmpMatrix":Landroid/graphics/Matrix;
    .end local v32    # "w":I
    .end local v36    # "x":F
    .end local v37    # "y":F
    :cond_18
    ...
    .end local v31    # "virtualScreenOffset":Landroid/graphics/PointF;
    .end local v34    # "wallpaperTarget":Lcom/android/server/wm/WindowState;
    :cond_19
    const/4 v8, 0x0
    ...
    .restart local v33    # "wallpaperAnimator":Lcom/android/server/wm/WindowStateAnimator;
    .restart local v34    # "wallpaperTarget":Lcom/android/server/wm/WindowState;
    :cond_1c
    move-object/from16 v0, v34
    ...
    .local v14, "h":F
    .restart local v25    # "screenAnimation":Z
    .restart local v29    # "tmpFloats":[F
    .restart local v30    # "tmpMatrix":Landroid/graphics/Matrix;
    .restart local v31    # "virtualScreenOffset":Landroid/graphics/PointF;
    .local v32, "w":F
    :cond_1e
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v38 .. v39}, Lcom/android/server/wm/AccessibilityController;->getMagnificationSpecForWindowLocked(Lcom/android/server/wm/WindowState;)Landroid/view/MagnificationSpec;
    ...
    invoke-virtual/range {v38 .. v38}, Lcom/android/server/wm/WindowState;->getWindowEasyOneHandScaleSpecLocked()Landroid/view/MagnificationSpec;
    ...
    const-string/jumbo v40, "computeShownFrameLocked: Animating "
    ...
    invoke-virtual/range {v38 .. v38}, Lcom/android/server/wm/AccessibilityController;->onSomeWindowResizedOrMovedLocked()V
    ...
    invoke-virtual/range {v38 .. v39}, Landroid/graphics/RectF;->set(Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v38 .. v40}, Landroid/graphics/RectF;->offset(FF)V
