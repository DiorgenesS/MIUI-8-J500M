...
.method public notifyOnDataActivity()V
    ...
    invoke-static/range {v23 .. v23}, Landroid/net/TrafficStats;->getTxPackets(Ljava/lang/String;)J
    ...
    invoke-static/range {v23 .. v23}, Landroid/net/TrafficStats;->getRxPackets(Ljava/lang/String;)J
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/wifi/WifiServiceImpl;->getConnectionInfo()Landroid/net/wifi/WifiInfo;

    move-result-object v22

    .line 367
    .local v22, "wifiInfo":Landroid/net/wifi/WifiInfo;
    sget v23, Lcom/android/server/wifi/WifiTrafficPoller;->mBusMaxValue:I
    ...
    .line 370
    const-string v23, "WifiTrafficPoller"

    const-string v24, "notifyOnDataActivity() - mBusMaxLock.acquire()"
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/os/DVFSHelper;->acquire()V
    ...
    const-string v25, " packet count Tx="
    ...
    sub-long v16, v24, v10

    .line 393
    .local v16, "received":J
    const-wide/16 v24, 0x0
    ...
    iget-wide v12, v0, Lcom/android/server/wifi/WifiTrafficPoller;->mTxBytes:J

    .local v12, "preTxBytes":J
    move-object/from16 v0, p0

    iget-wide v8, v0, Lcom/android/server/wifi/WifiTrafficPoller;->mRxBytes:J
    ...
    invoke-static/range {v23 .. v23}, Landroid/net/TrafficStats;->getTxBytes(Ljava/lang/String;)J
    ...
    invoke-static/range {v23 .. v23}, Landroid/net/TrafficStats;->getRxBytes(Ljava/lang/String;)J
    ...
    sget-object v24, Lcom/android/server/wifi/WifiTrafficPoller;->mCurrentMode:Lcom/android/server/wifi/WifiTrafficPoller$BoosterMode;

    invoke-virtual/range {v24 .. v24}, Lcom/android/server/wifi/WifiTrafficPoller$BoosterMode;->ordinal()I
    ...
    invoke-virtual/range {v23 .. v24}, Landroid/os/DVFSHelper;->acquire(I)V
    ...
    const-string v25, "notifying of data activity "
    ...
    .end local v16    # "received":J
    .end local v18    # "sent":J
    .end local v20    # "threshold":J
    :cond_8
    move-object/from16 v0, p0
    ...
    const-string v24, "notifyOnDataActivity() - mBusMaxLock.release()"
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/os/DVFSHelper;->release()V
