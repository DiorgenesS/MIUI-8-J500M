...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/app/WallpaperManager;->SYSFS_OCTA_WINDOW_TYPE_FROM_PANEL:Ljava/lang/String;

    .line 121
    const-string v0, "android.res://android/drawable/"
...
.method static generateBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    const-string v16, "generateBitmap is null"
    ...
    .line 1786
    iget v15, v8, Landroid/util/DisplayMetrics;->noncompatDensityDpi:I

    move-object/from16 v0, p1

    invoke-virtual {v0, v15}, Landroid/graphics/Bitmap;->setDensity(I)V
    ...
    invoke-virtual {v3, v6}, Landroid/view/Display;->getDisplayInfo(Landroid/view/DisplayInfo;)Z

    .line 1790
    sget-boolean v15, Landroid/app/WallpaperManager;->DEBUG:Z
    ...
    const-string v17, "generateBitmap :: width:"
    ...
    const-string v17, " displayInfo.logicalWidth:"
    ...
    const-string v17, "  displayInfo.logicalHeight:"
    ...
    .line 1798
    .local v10, "newbm":Landroid/graphics/Bitmap;
    invoke-virtual/range {p0 .. p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v15

    const-string v16, "android.wallpaper.settings_systemui_transparency"
    ...
    const-string v17, "Preload/Theme wallpaper downsize.:"
    ...
    invoke-static {v0, v12}, Landroid/app/WallpaperManager;->resizeBitmap(Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    ...
    const-string v16, "generateBitmap :: returning early "
    ...
    const-string v16, "Assuming Texture compressed bitmap."
    ...
    invoke-virtual {v13, v15, v0}, Landroid/graphics/Rect;->offset(II)V
    ...
    invoke-virtual {v11, v15}, Landroid/graphics/Paint;->setXfermode(Landroid/graphics/Xfermode;)Landroid/graphics/Xfermode;
    ...
    invoke-virtual {v2, v0, v15, v13, v11}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .end local v4    # "deltah":I
    .end local v5    # "deltaw":I
    ...
    const-string v16, "Can\'t generate default bitmap"
    ...
    .restart local v4    # "deltah":I
    .restart local v5    # "deltaw":I
...
.method private static getDefaultWallpaperID(Landroid/content/Context;)I
    ...
    const-string v6, "default wallpaper name:"
    ...
    const-string/jumbo v6, "no color wallpaper get default wallpaper id:"
...
.method public static getDeviceColor(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Landroid/app/WallpaperManager;->readColorId()I
...
.method private static readColorId()I
    .locals 6
    ...
    invoke-static {}, Landroid/app/WallpaperManager;->readWindowType()Ljava/lang/String;
...
.method private static readWindowType()Ljava/lang/String;
    .locals 8
    ...
    sget-object v6, Landroid/app/WallpaperManager;->SYSFS_OCTA_WINDOW_TYPE_FROM_PANEL:Ljava/lang/String;
...
.method public getDefaultWallpaperInformation()Landroid/os/Bundle;
    ...
    .line 1993
    .local v8, "wallpaperList":[Ljava/lang/String;
    ...
    invoke-static {v10, v11}, Landroid/app/WallpaperManager$Globals;->access$600(Landroid/app/WallpaperManager$Globals;Z)Ljava/io/File;
    ...
    sget-object v10, Landroid/app/WallpaperManager;->mCSCDefaultWallpaperlist:Ljava/util/ArrayList;
    ...
    invoke-static {v10}, Landroid/app/WallpaperManager;->getDeviceColor(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v11, Landroid/app/WallpaperManager;->DEFAULT_WALLPAPER_NAME:Ljava/lang/String;
    ...
    sget-object v11, Landroid/app/WallpaperManager;->DEFAULT_THUMB_NAME:Ljava/lang/String;
    ...
    invoke-virtual {v10, v3, v11, v12}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    sget-object v11, Landroid/app/WallpaperManager;->ANDROID_RES_PREFIX:Ljava/lang/String;
    ...
    const-string v11, "?locType=preloadDefault"
    ...
    .line 2012
    .local v9, "wallpaper_name":Ljava/lang/String;
    ...
    .line 2015
    .local v7, "thumb_name":Ljava/lang/String;
    iget-object v10, p0, Landroid/app/WallpaperManager;->mContext:Landroid/content/Context;
    ...
    const-string v12, "getDefaultWallpaperID:"
    ...
    const-string v11, "?locType=preload"
    ...
    .line 2010
    .end local v7    # "thumb_name":Ljava/lang/String;
    :cond_0
    ...
    .line 2006
    .end local v4    # "i":I
    .end local v9    # "wallpaper_name":Ljava/lang/String;
    :cond_1
    new-instance v10, Ljava/lang/StringBuilder;
    ...
    :cond_2
    const-string/jumbo v10, "paramKeyUriList"
